    ...
    while actual is not None:
        ...
        while siguiente_nodo is not None:
            ...
            if criterio == 'codigo':
                ...
                # Apellidos siempre ascendente según los acuerdos
...
def insertar_ordenado(lista: 'Lista_doble', estudiante: Estudiante) -> None:
    ...
    # Caso 2: Insertar al inicio (el nuevo código es menor que el de la cabeza)
    ...
    # Caso 3: Buscar la posición intermedia o final
    actual = lista.cabeza
